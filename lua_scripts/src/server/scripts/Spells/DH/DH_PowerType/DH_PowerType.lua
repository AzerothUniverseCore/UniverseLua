...
--Demon Hunter--
customPowerTypes["Fury"] =                    
{
    classesString = {
        frFR = "Chasseur de démons", -- Français
        enUS = "Demon Hunter"       -- Anglais
    },
	classesID = {13},
    defaultMax = 110000,
    id = 202,
    powerString = "Fury",
    color = { r = 0.788, g = 0.259, b = 0.992 },
    consumingSpells = {100018, 193840, 98996, 210153, 201427},
    passiveUpdate = {                                                                   
                        interval = 100,                                                 
                        UpdateFunc = function(event, delay, repeats, player)        
                            ...
                            local newPower = prevPower + (regen * (delay / 100))
