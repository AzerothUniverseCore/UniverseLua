...
local npcEntry = 9000384 -- Remplacez 12345 par l'ID d'entrée de votre miniboss
...
function MiniBossOrc_OnEnterCombat(event, creature, target)
    creature:RegisterEvent(MiniBossOrc_CastRandomSpell, 3000, 0) -- Lancer un sort aléatoire toutes les 6 secondes
end
