...
local Locales = {
    frFR = {
        ...
        CLASSES = "En plus des classes WotLK, on a porte le Moine, le Chasseur de Demons et l'Evocateur, et cree 2 classes 100% custom : Mage de Guerre du Sang et Heros. Il y a aussi 8 specialisations prestige exclusives : Pyromancien, Geomancien, Chronomancien, Empoisonneur, Necromancien, Ravageur du Chaos, Maitre des Betes et Chevalier.",
        PROGRESSION = "Au niveau max, la progression continue avec le systeme Paragon et le systeme Rebirth, les armes artefacts (A0 a A8, ameliorables), et l'equipement Heroique (S0 a S8) puis Mythique (jusqu'a M+8) avec du Mythique+ complet, du raid Mythique et des donjons Mythique+. Les plafonds de statistiques ont ete supprimes !",
        ...
        ACCOUNTFEATURES = "Ton compte peut avoir jusqu'a 20 personnages par royaume. Les hauts faits sont partages sur tout le compte, et tu disposes de Grimoires d'Identite et de Conversion pour gerer tes dons/votes.",
    ...
    enUS = {
        ...
        CLASSES = "On top of the WotLK classes, we ported the Monk, Demon Hunter and Evoker, and created 2 fully custom classes: Blood War Mage and Hero. There are also 8 exclusive prestige specializations: Pyromancer, Geomancer, Chronomancer, Venomancer, Necromancer, Chaos Ravager, Beastmaster and Knight.",
        PROGRESSION = "At max level, progression continues with the Paragon and Rebirth systems, artifact weapons (A0 to A8, upgradeable), and Heroic gear (S0 to S8) then Mythic gear (up to M+8) with full Mythic+, Mythic raid difficulty and Mythic+ dungeons. Stat caps have been removed!",
        ...
        ACCOUNTFEATURES = "Your account can have up to 20 characters per realm. Achievements are shared account-wide, and you have Identity and Conversion Grimoires to manage your donations/votes.",
...
local Topics = {
    ...
    { key = "CLASSES", keywords = { "classe custom", "custom class", "classe heros", "hero class", "moine", "monk", "chasseur de demon", "chasseur de démons", "demon hunter", "evocateur", "évocateur", "evoker", "mage de guerre du sang", "blood war mage", "pyromancien", "pyromancer", "geomancien", "geomancer", "chronomancien", "chronomancer", "empoisonneur", "venomancer", "necromancien", "necromancer", "ravageur du chaos", "chaos ravager", "maitre des betes", "beastmaster", "specialisation prestige", "prestige specialization" } },
    { key = "PROGRESSION", keywords = { "paragon", "rebirth", "arme artefact", "armes artefact", "artifact weapon", "equipement heroique", "heroic gear", "equipement mythique", "mythic gear", "mythique+", "mythic+", "m+full", "raid mythique", "mythic raid", "plafond de statistique", "stat cap" } },
