...
local Locales = {
    frFR = {
        ...
        PROGRESSION = "Au niveau max, la progression continue avec le systeme Parangon et le systeme Rebirth (avec sa propre Pierre de Rebirth), les armes artefacts (A0 a A8, ameliorables), et l'equipement Heroique (S0 a S8) puis Mythique (jusqu'a M+8) avec du Mythique+ complet, du raid Mythique et des donjons Mythique+. Les plafonds de statistiques ont ete supprimes !",
    ...
    enUS = {
        ...
        PROGRESSION = "At max level, progression continues with the Parangon and Rebirth systems (Rebirth has its own Pierre de Rebirth stone), artifact weapons (A0 to A8, upgradeable), and Heroic gear (S0 to S8) then Mythic gear (up to M+8) with full Mythic+, Mythic raid difficulty and Mythic+ dungeons. Stat caps have been removed!",
