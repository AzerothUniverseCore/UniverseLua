...
local function onLKSpawn(event, object)
    object:SetNPCFlags(3)
end
...
RegisterGameObjectEvent(NPC_LK, 5, onLKSpawn)
RegisterGameObjectGossipEvent(NPC_LK, 1, onGossipHello)
RegisterGameObjectGossipEvent(NPC_LK, 2, onGossipSelect)
