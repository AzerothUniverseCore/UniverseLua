...
local function SetReputationOnCharacterCreate(event, player)
    ...
    for factionId, _ in pairs(allianceFactions) do
        if isAlliance then
            ...
            CharDBExecute("INSERT IGNORE INTO character_reputation (guid, faction, standing) VALUES (" .. newCharacterGuid .. ", " .. factionId .. ", " .. adjustedStanding .. ") ON DUPLICATE KEY UPDATE standing = " .. adjustedStanding)
        end
    end
