...
local T = {
		...
		[3] = { "|TInterface\\icons\\DP:35|t Azeroth Universe", 2,
                {"|TInterface\\icons\\ability_bossfellord_felfissure:35|t |cffffff00(Aventure)|r Vaisseau de la Légion", 781, -11800.76, 2974.97, 2745.97, 1.57},
				{"|TInterface\\icons\\spell_holy_pureofheart:35|t |cffffffff(Cosmétique)|r Le Vindicaar", 781, -10985.1, 2748.45, 332.855, 4.68076},
				{"|TInterface\\icons\\spell_holy_lightsgrace:35|t |cff008000(Métiers)|r Sanctum de la Lumière", 781, -11237.9, 3285.19, 163.365, 1.56564},
				{"|TInterface\\icons\\spell_arcane_teleportdalaranbrokenisles:35|t |cff008000(Zone)|r Dalaran (Légion)", 781, -11908.80, 2961.10, 1857.40, 5.04},
				...
				{"|TInterface\\icons\\spell_arcane_teleporthalloftheguardian:35|t |cff008000(Entraîneur)|r Hall du Gardien", 800, -816.193, 4692.72, 939.663, 3.0359},
				{"|TInterface\\icons\\_HearthStoneDark_Priest:35|t |cffffffff(Cosmétique)|r Temple Halo-du-Néant", 801, 1234.33, 1344.18, 185.081, 0.00819301},
				{"|TInterface\\icons\\_HearthStoneDark_Shaman:35|t |cffffffff(Event)|r Le Maelström", 802, 1070.35, 1119.89, 19.6602, 4.07609},
		...
		[5] = { "|TInterface\\icons\\spell_arcane_teleportstormwind:35|t Donjons/Raids", 2,
				...
				{"|TInterface\\icons\\spell_arcane_teleportstormwind:35|t [3] Chemin du Rêve d'émeraude", 822, 1658.18, 1573.7, 5.84094, 2.46316},
		},
}
