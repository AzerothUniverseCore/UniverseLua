...
local UnitEntry = 3150

local T = {
        [1] = { "|TInterface\\icons\\achievement_zone_stranglethorn_01:35|t Strangleronce", 2,
				{"|TInterface\\icons\\achievement_zone_stranglethorn_01:35|t Se téléporter", 0, -12420.799, 206.87, 31.26, 3.04},
	},			
}
